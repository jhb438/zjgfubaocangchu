...
public class DateUtil {
	...
	public static String changeTimeStr(String dateStr) {
		...
		return SDF_YMDHMS.format(new Date(Long.valueOf(dateStr)));
	}
	...
	public static Date changeStrToTime(String dateStr){
		try {
			return  SDF_YMDHMS.parse(dateStr);
		} catch (ParseException e) {
			e.printStackTrace();
		}
		return null;
	...
	public static String getYmdhmsFName(Date date) {
		return SDF_YMDHMS_FNAME.format(date);
	}
