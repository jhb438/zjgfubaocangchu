...
public interface FbDooreventsService {
	...
	//找出所有的入
	List<FbDoorevents> getEventListByRu(String areaName,String isCBS,String isVTZ,String personName,String orgName);
	//找出所有实际的出
	List<FbDoorevents> getEventListByShiJiChu(String areaName,String isCBS,String isVTZ,String personName,String orgName);
